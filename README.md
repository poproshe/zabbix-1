...
wget https://repo.zabbix.com/zabbix/7.0/ubuntu/pool/main/z/zabbix-release/zabbix-release\_7.0-1+ubuntu24.04\_all.deb dpkg -i zabbix-release\_7.0-1+ubuntu24.04\_all.deb apt update
...
sed -i 's/\# DBPassword=/DBPassword=zabbix/' /etc/zabbix/zabbix\_server.conf
